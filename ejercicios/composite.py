...
#description: a class is declared by a component
...
class Child(Component): # Inherit from the abstract class, Component
    """ Concrete class """
...
class Composite(Component): # Inherits from the abstract class, Component
    ...
    def component_function(self):
        ...
        # Iterate through the child object and invoke their component fiunction printing their names
...
# Build a submenu 1 that is not a composite menu
top.append_child(sub1)
# Build a submenu 2 that is not a composite menu
top.append_child(sub2)

# Let's test if our Composite patters works!
